...
echo ""
echo "  Run voice chat:"
echo "    python main.py --voice --no-roomba                # push-to-talk"
echo "    python main.py --voice --no-roomba --continuous   # always-listening"
echo "    python main.py --voice                            # voice + Roomba hardware"
